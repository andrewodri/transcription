...
var MarkdownTransformer = (function () {
  ...
  _prototypeProperties(MarkdownTransformer, {
    transform: {
      value: function transform(files) {
        var markdownFiles = new Map();

        var navigation = MarkdownTransformer.buildNavigation(files);
          ...
          for (var _iterator = files[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            try {
              for (var _iterator2 = file.classes[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                ...
                markdownFiles.set(classObject.name.toLowerCase() + ".md", navigation + MarkdownTransformer.buildClass(classObject));
              }
            } catch (err) {
    ...
    buildNavigation: {
      value: function buildNavigation(files) {
        var result = "";
